...
export interface InboundMessageTaskPayload extends z.infer<typeof InboundMessageTaskPayload> {}
...
export const ScheduledTaskPayload = z.object({
  ...
  /** Feishu chat_id where results should be delivered. */
  chat_id: z.string().optional(),
});
export interface ScheduledTaskPayload extends z.infer<typeof ScheduledTaskPayload> {}
